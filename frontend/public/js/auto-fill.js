...
const AutoFill = {
  ...
  middleAndLastNames: [
    "Văn Anh", "Thị An", "Quốc Bảo", "Minh Châu", "Thanh Duy", "Thị Hà", "Văn Hải", 
    "Quang Huy", "Thị Hương", "Văn Khoa", "Thị Lan", "Quốc Minh", "Thị Ngọc", 
    "Văn Nam", "Thị Phương", "Quang Quân", "Thị Quỳnh", "Văn Sơn", "Thị Thảo", 
    "Quốc Tuấn", "Thị Tuyết", "Văn Vũ", "Thị Xuân", "Quang Yên", "Thị Yến",
    "Minh Đức", "Thị Đào", "Quốc Đạt", "Văn Đông", "Thị Hồng", "Quang Hùng",
    "Thị Mai", "Văn Mạnh", "Thị Nga", "Quốc Phong", "Thị Thủy", "Văn Thành",
    "Thị Thúy", "Quang Trung", "Thị Vân", "Văn Vinh", "Thị Xuyến", "Quốc Bình"
  ],
  
  // Danh sách tên miền email phổ biến
  emailDomains: [
    "gmail.com", "yahoo.com", "hotmail.com", "outlook.com", "duytan.edu.vn", 
    "icloud.com", "live.com", "mail.com", "protonmail.com", "zoho.com"
  ],
  
  // Danh sách chức vụ
  positions: [
    "Giảng viên", "Giảng viên chính", "Giảng viên cao cấp", "Trợ giảng", 
    "Phó trưởng bộ môn", "Trưởng bộ môn", "Phó trưởng khoa", "Trưởng khoa", 
    "Phó hiệu trưởng", "Hiệu trưởng", "Nghiên cứu viên", "Giảng viên thỉnh giảng",
    "Giảng viên kiêm nhiệm", "Giảng viên hướng dẫn", "Giáo vụ khoa"
  ],
  
  // Danh sách chuyên ngành
  specializations: [
    "Công nghệ thông tin", "Khoa học máy tính", "Kỹ thuật phần mềm", "Hệ thống thông tin", 
    "Mạng máy tính", "Trí tuệ nhân tạo", "An toàn thông tin", "Khoa học dữ liệu",
    "Quản trị kinh doanh", "Tài chính - Ngân hàng", "Kế toán", "Marketing", "Kinh tế quốc tế",
    "Du lịch", "Khách sạn", "Nhà hàng", "Quản trị dịch vụ du lịch và lữ hành",
    "Y khoa", "Dược học", "Điều dưỡng", "Y tế công cộng", "Răng - Hàm - Mặt",
    "Xây dựng", "Kiến trúc", "Cơ khí", "Điện - Điện tử", "Tự động hóa",
    "Ngôn ngữ Anh", "Ngôn ngữ Trung", "Ngôn ngữ Nhật", "Ngôn ngữ Hàn",
    "Luật", "Quan hệ quốc tế", "Báo chí", "Truyền thông đa phương tiện"
  ],
  ...
  universities: [
    ...
    "Đại học Bách Khoa TP.HCM", "Đại học Duy Tân", "Đại học Đà Nẵng", "Đại học Huế", 
    "Đại học Cần Thơ", "Đại học Ngoại thương", "Đại học Kinh tế Quốc dân",
    "Học viện Công nghệ Bưu chính Viễn thông", "Đại học Sư phạm Hà Nội",
    "Đại học Y Hà Nội", "Đại học Khoa học Tự nhiên", "Đại học Xây dựng",
    "Đại học Ngoại ngữ", "Đại học Luật Hà Nội", "Đại học Kinh tế TP.HCM",
    "Đại học Sư phạm TP.HCM", "Đại học Y Dược TP.HCM"
  ],
  
  // Danh sách công ty/tổ chức
  companies: [
    "Tập đoàn FPT", "Viettel", "VNG", "VNPT", "MobiFone", "Samsung Việt Nam", 
    "Intel Việt Nam", "Microsoft Việt Nam", "IBM Việt Nam", "Vingroup", 
    "Masan Group", "Techcombank", "Vietcombank", "Viện Hàn lâm Khoa học Việt Nam",
    "Bộ Khoa học và Công nghệ", "Bộ Giáo dục và Đào tạo", "Bộ Y tế",
    "Viện Nghiên cứu Cao cấp về Toán", "Viện Công nghệ Thông tin"
  ],
  
  // Danh sách tổ chức học thuật
  organizations: [
    "Hội Tin học Việt Nam", "Hội Toán học Việt Nam", "Hội Vật lý Việt Nam", 
    "Hội Hóa học Việt Nam", "Hội Điện tử Việt Nam", "Hội Tự động hóa Việt Nam", 
    "Hội Kỹ sư Xây dựng Việt Nam", "Hội Kiến trúc sư Việt Nam", "IEEE", "ACM"
  ],
  
  // Danh sách môn học
  subjects: [
    "Lập trình cơ bản", "Cấu trúc dữ liệu và giải thuật", "Cơ sở dữ liệu", 
    "Mạng máy tính", "Hệ điều hành", "Trí tuệ nhân tạo", "Học máy", "Phân tích thiết kế hệ thống", 
    "Công nghệ phần mềm", "An toàn thông tin", "Điện toán đám mây", "Internet vạn vật",
    "Kinh tế vĩ mô", "Kinh tế vi mô", "Marketing căn bản", "Quản trị học", "Tài chính doanh nghiệp",
    "Kế toán quản trị", "Quản trị nhân lực", "Quản trị chuỗi cung ứng", "Thương mại điện tử",
    "Giải phẫu học", "Sinh lý học", "Dược lý học", "Vi sinh y học", "Y học cộng đồng",
    "Vật lý đại cương", "Hóa học đại cương", "Toán cao cấp", "Xác suất thống kê",
    "Tiếng Anh chuyên ngành", "Kỹ năng giao tiếp", "Phương pháp nghiên cứu khoa học"
  ],
  ...
  generatePhoneNumber: function() {
    const prefixes = ['032', '033', '034', '035', '036', '037', '038', '039', // Viettel
                      '070', '076', '077', '078', '079', // Mobifone
                      '081', '082', '083', '084', '085', '086', '088', '089', // Vinaphone
                      '090', '091', '092', '093', '094', '096', '097', '098', '099']; // Các mạng khác
  ...
  generateBio: function(specialization) {
    ...
    for (let i = 0; i < subjectCount; i++) {
      let subject = this.getRandomItem(this.subjects);
...
// Thêm nút "Điền ngẫu nhiên" vào form
function addRandomFillButton() {
  const form = document.getElementById('instructor-form');
  if (!form) return;
  
  const buttonContainer = document.createElement('div');
  buttonContainer.className = 'mb-3 d-flex justify-content-start';
  
  const randomFillButton = document.createElement('button');
  randomFillButton.type = 'button';
  randomFillButton.className = 'btn btn-secondary me-2';
  randomFillButton.innerHTML = '<i class="bi bi-shuffle me-2"></i>Điền ngẫu nhiên';
  randomFillButton.onclick = function() {
    AutoFill.fillForm();
  };
  
  buttonContainer.appendChild(randomFillButton);
  
  // Thêm nút vào đầu form
  form.insertBefore(buttonContainer, form.firstChild);
  
  console.log('Đã thêm nút "Điền ngẫu nhiên" vào form!');
}

// Tự động thêm nút khi trang được tải
